      ...
      <main className="ml-64">
        ...
        <header className="sticky top-0 z-40 bg-black/40 backdrop-blur-xl border-b border-white/5 px-8 py-4 relative">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-white">Conquistas e Certificados</h1>
              <p className="text-white/60 text-sm mt-1">Acompanhe seu progresso e celebre suas conquistas</p>
            </div>
        ...
        <section className="px-8 py-8">
          <div className="grid grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all group">
        ...
        <div className="px-8 pb-8 grid grid-cols-3 gap-8">
          ...
          <div className="col-span-2 space-y-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden">
              <div className="relative bg-gradient-to-br from-[#050505] via-[#0a0a0a] to-[#050505] p-12">
                {/* Decorative Elements */}
                <div className="absolute top-0 left-0 w-full h-full opacity-10">
                  <div className="absolute top-8 left-8 w-32 h-32 border-2 border-[#63E3FF] rounded-full"></div>
                  <div className="absolute bottom-8 right-8 w-40 h-40 border-2 border-[#E548FF] rounded-full"></div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="text-right">
                      <p className="text-white/60 text-sm">Certificado ID</p>
                      <p className="text-white font-mono">#VRS-2026-001</p>
                    </div>
                  </div>

                  {/* Title */}
                  <div className="text-center mb-8">
                    <h2 className="text-4xl font-bold text-white mb-2">Certificado de Conclusão</h2>
                    <p className="text-white/60">Versia Corporate Learning Platform</p>
                  </div>

                  {/* Content */}
                  <div className="text-center mb-8">
                    <p className="text-white/60 mb-4">Este documento certifica que</p>
                    <h3 className="text-3xl font-bold bg-gradient-to-r from-[#63E3FF] via-[#2FA7FF] to-[#7A2CFF] bg-clip-text text-transparent mb-4">
                      João Silva
                    </h3>
                    <p className="text-white/60 mb-2">concluiu com sucesso o curso</p>
                    <h4 className="text-2xl font-bold text-white mb-6">Compliance e Ética Empresarial</h4>
                  ...
                  <div className="border-t border-white/10 pt-6 flex justify-center">
                    <div className="text-center">
                      <div className="w-48 border-b-2 border-white/20 mb-2"></div>
                      <p className="text-white/60 text-sm">Assinatura Digital Verificada</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/40 p-6 flex items-center justify-between">
                <p className="text-white/60 text-sm">Emitido em 15 de Março, 2026</p>
                <div className="flex items-center gap-3">
                  <button className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-all flex items-center gap-2">
                    <Share2 className="w-4 h-4" />
                    Compartilhar
                  </button>
                  <button className="px-4 py-2 rounded-xl font-semibold text-white shadow-lg transition-all flex items-center gap-2"
                    style={{
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              <h3 className="text-xl font-bold text-white mb-6">Todos os Certificados</h3>
              <div className="space-y-4">
                {certificates.map((cert) => (
                  <div key={cert.id} className="bg-white/5 border border-white/10 rounded-xl p-5 hover:bg-white/10 transition-all group cursor-pointer">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#63E3FF] to-[#7A2CFF] flex items-center justify-center flex-shrink-0">
                          <Award className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <h4 className="text-white font-semibold mb-1">{cert.course}</h4>
                      ...
                      <div className="flex items-center gap-2">
                        <button className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-all">
                          <Download className="w-4 h-4" />
                        </button>
                        <button className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-all">
                          <Share2 className="w-4 h-4" />
          ...
          <div className="space-y-8">
            {/* Badges */}
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              <h3 className="text-xl font-bold text-white mb-6">Badges Conquistadas</h3>
            ...
            {/* Timeline */}
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              <h3 className="text-xl font-bold text-white mb-6">Histórico Recente</h3>
